...
const GameDetailsModal: FC<Props> = ({ gameId, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 md:p-10">
      ...
      {/* Modal Panel */}
      <div className="relative w-full max-w-5xl max-h-[92vh] bg-zinc-900 rounded-3xl overflow-y-auto shadow-[0_0_60px_rgba(0,0,0,0.8)] ring-1 ring-white/5 flex flex-col z-10">
        ...
        {game && (
          <div className="flex flex-col">
            ...
            <div className="relative w-full h-56 md:h-80 shrink-0">
              ...
              <div className="absolute inset-0 bg-linear-to-t from-zinc-900 via-zinc-900/50 to-transparent rounded-t-3xl" />
